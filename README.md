...
<p align="center"><em>PRISM-Memory trains a 7B open model to extract proposition-level memory from dialogue, then measures it against the GPT-4.1 extraction baseline it is trying to replace.</em></p>
...
memory work in this workspace, but those exploratory runs are intentionally
kept out of the top-level release story until the candidate, artifact layout,
and reporting surface are promoted.
